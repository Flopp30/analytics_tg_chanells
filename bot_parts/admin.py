...
class SettingsAdmin(admin.ModelAdmin):
    list_display = (
        "edit", 'additional_percents_for_repost', 'starting_interval_second_task', 'min_messages_count_before_repost',
        'min_metrics_count_before_repost', 'messages_ttl', 'views_div'
    )
    list_per_page = 1
